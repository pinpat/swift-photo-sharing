        ...
        subscription: new graphql_1.GraphQLObjectType({
            ...
            fields: {
                ...
                testPatternSubscription: {
                    type: graphql_1.GraphQLString,
                    subscribe: with_filter_1.withFilter(function () { return patternIterator; }, function () { return true; }),
                    resolve: function (root) {
                        return 'SECOND_EVENT';
                    },
                },
...
describe('PubSubAsyncIterator', function () {
    ...
    var patternQuery = graphql_1.parse("\n    subscription S1 {\n      testPatternSubscription\n    }\n  ");
    var pubsub = new redis_pubsub_1.RedisPubSub();
    var origIterator = pubsub.asyncIterator(FIRST_EVENT);
    var origPatternIterator = pubsub.asyncIterator('SECOND*', { pattern: true });
    var returnSpy = simple_mock_1.mock(origIterator, 'return');
    var schema = buildSchema(origIterator, origPatternIterator);
    before(function () {
    ...
    it('should allow subscriptions', function () {
        return subscription_1.subscribe(schema, query)
            .then(function (ai) {
    ...
    it('should allow pattern subscriptions', function () {
        return subscription_1.subscribe(schema, patternQuery)
            .then(function (ai) {
            expect(iterall_1.isAsyncIterable(ai)).to.be.true;
            var r = ai.next();
